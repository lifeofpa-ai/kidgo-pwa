              ...
              <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                ...
                {/* Search Section */}
                      <section className="bg-white rounded-xl shadow-lg p-6 sm:p-8 mb-8">
                                <h3 className="text-2xl font-bold mb-6">🔍 Events suchen</h3>h3>
                ...
                {/* Results Section */}
                      ...
                      <div className="text-center py-16">
                                    <p className="text-gray-500 text-lg">⏳ Events werden geladen...</p>p>
                      </div>div>
                    ) : events.length === 0 ? (
                      <div className="text-center py-16">
                ...
                {/* Footer Info */}
                      <footer className="mt-12 text-center text-gray-600 text-sm">
                                <p>🚀 Kidgo PWA - Alpha Version | Powered by Next.js + Supabase</p>p>
                      </footer>footer>
              </div>div>
        </main>main>
      );
